# CATATAN-SEKERTARIS — Categories & Index

Di-update: 21 September 2026

Fungsi: catatan harian Advan (guru/admin sekolah), terpisah per topik.
Sync via GitHub → bisa dibuka dari PC manapun (PC-06, Advan, HP).

## File Topik
- **Kerjaan Sekolah** → `CATATAN-KERJAAN-SEKOLAH.md` (absensi, dokumen ujian, RPP, guru/NIP/NUPTK)
- **Catatan Keuangan** → `CATATAN-KEUANGAN.md`
- **Agenda Kegiatan Sekolah** → `CATATAN-AGENDA-SEKOLAH.md`
- Catatan umum/lain-lain → file ini

## Cara Pakai
- Tiap sesi, asisten catat hal penting di file topik yang sesuai
- Paling baru di atas
- Format: TANGGAL → isi singkat + follow-up kalau ada

---

## 21 September 2026

- **Setup server HP (Poco X7 Pro):** termux jalan 24/7 wakelock aktif, website methodist-11.my.id live, terminal online bisa resume session & max 2 terminal
