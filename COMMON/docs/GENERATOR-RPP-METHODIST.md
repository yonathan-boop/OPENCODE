# GENERATOR-RPP for SD Swasta Methodist-11
...
- **Nama sekolah** → dropdown: SD Swasta Methodist-11 (default) / SMP Swasta Methodist-11. **Tanpa kata "Medan"** (koreksi user 15/9).
