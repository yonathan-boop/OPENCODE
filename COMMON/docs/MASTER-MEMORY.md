...
- **ARSIP SESI OPENCODE (11/9):** dari 38 sesi → 32 di-arsip kan (yang terakhir dipakai sebelum 9/9), 6 aktif tersisa. Data sesi arsip TETAP tersimpan (set `time_archived` saja, bukan delete).
