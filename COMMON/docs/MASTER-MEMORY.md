...
- KSP SD 2026/2027 SD Swasta Methodist-11 (22/9): Pengerjaan Kurikulum Satuan Pendidikan (KSP) Dokumen I TP 2026/2027 di `C:\RaporServer\KOSP KURMER\Edit pc\` berdasarkan template BPMP & instrumen validasi KSP Kota Medan (`INSTRUMEN VALIDASI KSP 2025.xlsx`). Cover & Identitas Sekolah sudah selesai diisi data resmi lengkap & logo, layout dipresisikan 1 halaman/bagian (`TEMPLATE KSP 2026 2027 REVISI BPMP.docx` & `SD KSP 26-27 - DOKUMEN 1.docx`).
